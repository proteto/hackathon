        ...
        <div className="flex flex-row items-start justify-start bg-gray-900 overflow-x-hidden">
          ...
          `}>
            ...
            <div className="flex flex-col w-full max-w-7xl mx-auto">
                {/* Content area */}
                <div
                    className={`w-full min-h-screen overflow-hidden px-4 md:px-0 transition-all duration-300 ${isSidebarOpen ? 'pointer-events-none md:pointer-events-auto opacity-50 md:opacity-100' : 'opacity-100'}`}
                >
